...
import { Calendar, Edit3, Settings, Smartphone, PieChart, MousePointer2, Palette, BarChart3, Zap } from "lucide-react";
...
export function Features() {
  const features = [
    {
      icon: MousePointer2,
      title: "Precision Range Select",
      description: "Experience fluid drag-to-select interaction. Document entire periods with professional-grade precision metrics.",
      delay: 0.1
    },
    {
      icon: BarChart3,
      title: "Smart Analytics Hub",
      description: "Visualize your throughput with real-time analytics. Categorized tracking for work, personal, and urgent targets.",
      delay: 0.2
    },
    {
      icon: Palette,
      title: "Dynamic Accent Themes",
      description: "One-click aesthetic personalization. Choose from a curated palette of professional accent colors to match your brand.",
      delay: 0.3
    },
    {
      icon: Zap,
      title: "MASTER NAVIGATION",
      description: "Full keyboard mastering for rapid document entry. Arrow keys and Shift modifiers for no-friction planning.",
      delay: 0.4
    }
  ];
