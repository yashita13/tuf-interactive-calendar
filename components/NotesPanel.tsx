    ...
    <div className="w-full h-full flex flex-col group min-h-[500px] md:min-h-[700px] transition-all">
      ...
      {activeDate && (
        <motion.div
          ...
          className="mb-2 md:mb-8 p-4 bg-background/40 rounded-2xl border border-border-color border-dashed"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="relative flex-grow bg-background/60 backdrop-blur-sm rounded-2xl p-6 border border-border-color shadow-2xl transition-all focus-within:border-accent-blue/40 focus-within:ring-1 focus-within:ring-accent-blue/20">
            <textarea
              ...
              className="w-full min-h-[60px] md:min-h-[140px] bg-transparent resize-none focus:outline-none text-base text-foreground leading-relaxed font-medium placeholder:text-gray-text/20 transition-all z-10"
